...
public class RestaurantsDao {
    ...
    public Restaurants getRestaurantById(int restaurantId) throws SQLException {
        String selectRestaurant = "SELECT RestaurantId, Name, Description, Menu, Hours, Active, Cuisine,"
        ...
        try {
            ...
            if(results.next()) {
                ...
                Restaurants restaurant = new Restaurants(restId, name, desc, menu, hours, active, ct, street1, street2, city, state, zip, companyName);
                return restaurant;
            }
        } catch (SQLException e) {
            e.printStackTrace();
