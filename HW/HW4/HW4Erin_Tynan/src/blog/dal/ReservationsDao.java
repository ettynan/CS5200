...
public class ReservationsDao {
    ...
    public Reservations create(Reservations reservations) throws SQLException {
        String insertReservation =
                "INSERT INTO Reservations(ReservationId, Start, End, Size, UserName, RestaurantId) " +
                        "VALUES(?,?,?,?,?,?);";
        ...
        try {
            ...
            insertStmt.setTimestamp(2, new Timestamp (reservations.getStart().getTime()));
            insertStmt.setTimestamp(3, new Timestamp (reservations.getEnd().getTime()));
