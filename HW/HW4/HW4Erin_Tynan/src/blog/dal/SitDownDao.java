...
public class SitDownDao extends RestaurantsDao {
	...
	public SitDown create(SitDown sitDown) throws SQLException {
		...
		String insertSDR = "INSERT INTO SitDownRestaurant(RestaurantId, Capacity) VALUES(?,?)";
	...
	public SitDown delete(SitDown sitDown) throws SQLException {
		String deleteSDR = "DELETE FROM SitDownRestaurant WHERE RestaurantId=?;";
		Connection connection = null;
	...
	public SitDown getSitDownById(int restaurantId) throws SQLException {
        String selectSDR = "SELECT sdr.RestaurantId, Name, Description, Menu, Hours, Active, Cuisine, Street1,"
                + "Street2, City, State, Zip, CompanyName, Capacity FROM SitDownRestaurant AS sdr JOIN Restaurants on sdr.RestaurantId=Restaurants.RestaurantId "
                + "WHERE sdr.RestaurantId=?;";
        Connection connection = null;
        ...
        try {
            ...
            while(results.next()) {
                int restId = results.getInt("sdr.RestaurantId");
                String name = results.getString("Name");
                String desc = results.getString("Description");
                String menu = results.getString("Menu");
                String hours = results.getString("Hours");
                Boolean active = results.getBoolean("Active");
                Restaurants.CuisineType ct = Restaurants.CuisineType.valueOf(results.getString("Cuisine"));
                ...
                SitDown sdr = new SitDown(restId, name, desc, menu, hours, active, ct, s1, s2, city, state, zip, companyName, cap);
                return sdr;
            }
