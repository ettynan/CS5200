...
public class Inserter {
	...
	public static void main(String[] args) throws SQLException {
        ...
        if(userDel==null) {
            ...
            System.out.print("User4 not deleted\n");
        ...
        if(cardDel==null) {
            ...
            System.out.print("Card13 not deleted \n");
        }
        ...
        if(companyDel==null) {
            ...
            System.out.print("Company3 not deleted \n");
        }
        ...
        if(restDel==null) {
            ...
            System.out.print("Restaurant6 not deleted \n");
        }
        ...
        if(sitDownDel==null) {
            System.out.print("SitDown2 deleted \n");
        }
        else {
            System.out.print("SitDown2 not deleted \n");
        }
        ...
        if(takeOutDel==null) {
            ...
            System.out.print("TakeOut1 not deleted \n");
        }
        ...
        if(foodCartDel==null) {
            ...
            System.out.print("FoodCart2 not deleted \n");
        }
        ...
        Recommendations recDel = recommendationsDao.getRecommendationsById(recommendation5.getRecommendationId());
        if(recDel==null) {
        ...
        if(resDel==null) {
            System.out.print("Reservation9 deleted \n");
        }
        else {
            System.out.print("Reservation9 not deleted \n");
        }
	}
}
