...
<title>Find an Inspection</title>
</head>
<body>
	<form action="findinspectionbyinspectionkey" method="post">
	<div class="jumbotron">
		<h1>Search for an Inspection by the Inspection Key</h1>
	</div>
		<p>
	...
	<h3>Matching Inspection</h3>
        <table class="table table-striped">
            ...
            <tr>
                <td>${inspectionHistory.getInspectionHistoryKey()}</td>
                <td>${inspectionHistory.getEstablishmentName()}</td>
                <td><fmt:formatDate value="${inspectionHistory.getInspectionDate()}" pattern="yyyy-MM-dd"/></td>
                <td>${inspectionHistory.getInspectionResult()}</td>
                <td>${inspectionHistory.getFoodEstablishment().getFoodEstablishmentKey()}</td>
