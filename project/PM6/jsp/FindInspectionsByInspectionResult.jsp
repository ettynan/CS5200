...
<body>
	<form action="findinspectionsbyinspectionresult" method="post">
	<div class= "jumbotron">
		<h1>Search for a Inspections by Inspection Result</h1>
	</div>
		<p>
			<label for="result">Inspection Result</label>
			<input id="result" name="result" value="${fn:escapeXml(param.result)}">
		</p>
		<p>
			<input type="submit">
			<br/><br/><br/>
