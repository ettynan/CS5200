...
<title>Find Inspections by Date</title>
</head>
<body>
	<form action="findinspectionsbyinspectiondate" method="post">
	<div class="jumbotron">
		<h1>Search for Inspections by Inspection Date</h1>
	</div>
		<p>
			<label for="inspectiondate">Inspection Date (yyyy-mm-dd)</label>
			<input id="inspectiondate" name="inspectiondate" value="${fn:escapeXml(param.inspectiondate)}">
		</p>
		<p>
			<input type="submit">
		</p>
