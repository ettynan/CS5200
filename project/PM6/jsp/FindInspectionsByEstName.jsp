...
<body>
	...
	<div class= "jumbotron">
		<h1>Search for a Inspections by Establishment Name</h1>
	</div>
		<p>
	...
	<div><a href="findestablishmentsbyname">Back Home (Find Establishments by Name)</a></div>
 	<div id="InspectionHistoryCreate"><a href="inspectionhistorycreate">Create Inspection</a></div>
 	<div id="FindViolationsByEstName"><a href="findviolationsbyestname">Find Violation</a></div>
 	<div id="ViolationHistoryCreate"><a href="violationhistorycreate">Create Violation</a></div> 
