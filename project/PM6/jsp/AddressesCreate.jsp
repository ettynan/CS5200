...
<title>Create an Address for an Establishment</title>
</head>
<body>
	<div class="jumbotron">
	...
	<div><a href="findaddressesbykey">Back to Find Addresses by EstablishmentKey</a></div>
	<div><a href="foodestablishmentscreate">Go to Create Food Establishments</a></div>
	<div><a href="liquorestablishmentscreate">Go to Create Liquor Establishments</a></div>
	<!-- Bootstrap scripts -->
