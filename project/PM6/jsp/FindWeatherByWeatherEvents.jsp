...
<title>Find Weather by Weather Events</title>
</head>
<body>
	<form action="findweatherbyweatherevents" method="post">
	<div class="jumbotron">
		<h1>Search for Weather by WeatherEvents</h1>
	</div>
		<p>
			<label for="weatherevent">WeatherEvent (Snow, Rain, Both, None)</label>
			<input id="weatherevent" name="weatherevent" value="${fn:escapeXml(param.weatherdate)}">
		</p>
		<p>
			<input type="submit">
		</p>
