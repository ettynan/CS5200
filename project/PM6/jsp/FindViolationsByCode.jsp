...
<body>
	<form action="findviolationsbycode" method="post">
	<div class="jumbotron">
		<h1>Search for Violations by the Violation Code</h1>
	</div>
		<p>
			<label for="violationcode">Violation Code</label>
			<input id="violationcode" name="violationcode" value="${fn:escapeXml(param.violationcode)}">
		</p>
		<p>
			<input type="submit">
			<br/><br/><br/>
