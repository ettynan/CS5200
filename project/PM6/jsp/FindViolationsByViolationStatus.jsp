...
<body>
	<form action="findviolationsbyviolationstatus" method="post">
		<div class= "jumbotron">
		<h1>Search for a Violations by Violation Status</h1>
		</div>
		<p>
			<label for="violationstatus">Violation Status</label>
			<input id="violationstatus" name="violationstatus" value="${fn:escapeXml(param.violationstatus)}">
		</p>
		<p>			
			<input type="submit">
			<br/><br/><br/>
