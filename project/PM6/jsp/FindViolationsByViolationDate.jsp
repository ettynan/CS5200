...
<body>
	<form action="findviolationsbyviolationdate" method="post">
	<div class="jumbotron">
		<h1>Search for Violations by Violation Date</h1>
	</div>
		<p>
			<label for="violationdate">ViolationDate (yyyy-mm-dd)</label>
			<input id="violationdate" name="violationdate" value="${fn:escapeXml(param.violationdate)}">
		</p>
		<p>
			<input type="submit">
		</p>
