...
<title>Find a License By License Number</title>
</head>
<body>
	<div class="container theme-showcase" role="main">
		<form action="findlicensesbylicensenumber" method="post">
		<div class="jumbotron">
			<h1>Search for a License by License Number</h1>
		</div>
			<p>
